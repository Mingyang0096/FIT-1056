...
class TeacherUser(User):
    ...
    def to_table(self):
        ...
        return [
            ...
            self.name,
            self.speciality,
            ", ".join(map(str, self.course_ids)) if self.course_ids else "-",
            self.last_updated
        ]
...
class Course:
    ...
    def from_dict(cls, data):
        ...
        course = cls(data["id"], data["name"], data.get("teacher_id"), data.get("instrument"))
    ...
    def to_table(self):
        ...
        return [
            ...
            self.name,
            self.teacher_id,
            ", ".join(map(str, self.enrolled_student_ids)) if self.enrolled_student_ids else "-"
        ]
